...
setup = do
  vao <- newVAO
  bindVAO vao
  vsource <- readFile =<< getDataFileName "shader.vert"
  fsource1 <- readFile =<< getDataFileName "shader1.frag"
  fsource2 <- readFile =<< getDataFileName "shader2.frag"
  fsource3 <- readFile =<< getDataFileName "shader3.frag"
